...
.data
  ...
  denovo2 DB 10, ' Refazer o jogo anterior -> (1)', 10, ' Sair do programa -> (3)', 10, '$'
 ...
 ; procedimento para inserir caractere no jogo:
  inserir PROC 
     ...
     comeco: 
       ...
       SUB BX, 30h                             ; operador OR entre o conteudo de BX e o numero hexadecimal 30h, obtendo o valor decimal em BX
       ...
       SUB SI, 30h                             ; #operador OR entre o conteudo de SI e o numero hexadecimal 30h, obtendo o valor decimal em SI
       ...
       SUB DH, 30h                             ; #operador OR entre o conteudo de DH e o numero hexadecimal 30h, obtendo o valor decimal em SI
       
       DEC SI                                  ; decrementa o registrador SI que contem as colunas 
       DEC BX                                  ; decrementa o registrador BX  que contem as linhas 
       MOV CH, linha                           ; move linha (numero de linhas=9) para CH     
       XCHG AX, BX                             ; realiza uma troca de conteudo entre os registradores AX e BX              
       MUL CH                                  ; multiplia o registrador CH 
       XCHG AX, BX                             ; realiza uma troca de conteudo entre os registradores AX e BX    
 
       XOR CX, CX                              ; zera o registrador CX 

       MOV CH, mat_pr[BX][SI]                  ; move o conteudo da 'mat_pr' para o registrador CH 
       CMP CH , '_'                            ; compara o conteudo do registrador CH com <espaço>
       JNE nao                                 ; realiza um 'Jump Not Equal' para 'nao'         

       
       MOV CH, mat_sol[BX][SI]                 ; move o conteudo da 'mat_sol' para o registrador CH 
       CMP CH, DH                              ; compara o conteudo do registrador CH com DH 
       JZ correto
       ...
       MOV AH, 02                              ; realiza a impressao de caractere
       MOV DL, erros                           ; move o numero de erros para o registrador DL 
       ADD DL, 30h                             ; transforma o codigo ascii em numero 
       INT 21H
       imp_str erro                            ; chamada macro 'imp_str', para impressao da mensagem 'erro'

       JMP comeco                              ; retorna para 'comeco'

     correto: 
       MOV mat_pr[BX][SI], DH                  ; move o contudo do registrador DH
       LEA BX, mat_pr
       CALL imprime_mat                        ; chama procedimento 'imprime_mat', para imprimir a matriz   
       JMP comeco
 ...
 ; procedimento para impressao da matriz:
  imprime_mat PROC  
     ...
     cont:
        ...
        CMP DL,  '_'                             ; compara conteudo de DL com o caractere '?'
 ...
 ; procedimento para impressao de mensagem final:
  ...
  inserir2 PROC
    ...
    comeco2: 
       ...
       MOV CH, linha                           ; move linha (numero de linhas=9) para CH  
       XCHG AX, BX                             ; realiza uma troca de conteudo entre os registradores AX e BX              
       MUL CH                                  ; multiplica o registrador CH 
       XCHG AX, BX                             ; realiza uma troca de conteudo entre os registradores AX e BX  

       XOR CX, CX                              ; zera o conteúdo do registrador CX 

       MOV CH, mat2_pr[BX][SI]                 ; zera o conteúdo do registrador CX 
       CMP CH , '_'                            ; compara o conteudo do registrador CH com <espaço>
       JNE nao2

       
       MOV CH, mat2_sol[BX][SI]                ; move o conteudo da 'mat2_sol' para o registrador CH
     ...
     correto2: 
       MOV mat2_pr[BX][SI], DH                  ; move o contudo do registrador DH
       LEA BX, mat2_pr
       CALL imprime_mat                         ;  chama procedimento 'imprime_mat', para imprimir a matriz
       JMP comeco2
